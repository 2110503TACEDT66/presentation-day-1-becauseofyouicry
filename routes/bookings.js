...
const {getBookings,getBooking,addBooking,updateBooking,deleteBooking,getBookingLocation} = require('../controllers/booking') ;
...
router.route('/:id/location').get(protect, authorize('admin','user'), getBookingLocation);
